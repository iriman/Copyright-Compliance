...
## رعایت شده
| نام برنامه/سایت | آدرس گوگل‌پلی/اپل‌استور/پیوند بارگیری | وضعیت رعایت کپی‌رایت | نگارش برنامه | تاریخ بروزرسانی برنامه | تاریخ آخرین بررسی | توضیحات | وضعیت آگاه‌سازی برنامه/سایت |
| ----- | ----- | ----- | ----- | ----- | ----- | ----- | ----- |
